...
class ComputeLoss:
    ...
    def build_targets(self, p, targets):
        ...
        for i in range(self.nl):  # 循环3个特征层
            ...
            # Match targets to anchors
            t = targets * gain  # shape(3,n,7),在特征图中恢复gt尺寸，[img_id,cls_id,x,y,w,h,anchor_idx]
            if nt:
                ...
                gxy = t[:, 2:4]  # grid xy
                gxi = gain[[2, 3]] - gxy  # inverse 特征图右下角为坐标原点
            ...
            # Define
            bc, gxy, gwh, a = t.chunk(4, 1)  # bc=[img_id, cls_id], grid xy, grid wh, anchors_id
